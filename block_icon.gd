...
static func get_tiles(block_type: int) -> Vector2i:
	match block_type:
		...
		Chunk.Block.SAPLING: return Vector2i(7, 7)
		Chunk.Block.FURNACE: return Vector2i(0, 70)
		Chunk.Block.CRAFTING_TABLE: return Vector2i(71, 4)
		Chunk.Block.COAL_BLOCK: return Vector2i(72, 72)
	return Vector2i(0, 0)
...
static func get_block_name(block_type: int) -> String:
	match block_type:
		...
		Chunk.Block.FURNACE: return "Furnace"
		Chunk.Block.CRAFTING_TABLE: return "Crafting Table"
		Chunk.Block.COAL_BLOCK: return "Coal Block"
		Chunk.Block.SAPLING: return "Oak Sapling"
	return "Unknown"
...
static func _is_sprite_block(block_type: int) -> bool:
	return block_type == Chunk.Block.FIRE \
		...
		or block_type == Chunk.Block.SAPLING
